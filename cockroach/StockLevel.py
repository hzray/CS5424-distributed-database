...
class StockLevel:
    ...
    def stock_level_handler(self):
        ...
        # print("the total number of items: {}".format(self.number), self.fo)
        self.fo.write("the total number of items: {}".format(self.number))
        # print("the total number of items: {}".format(self.number))
