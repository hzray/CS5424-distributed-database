...
IMPORT INTO CS5424.warehouse CSV DATA ('userfile:///a_warehouse.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.district CSV DATA ('userfile:///a_district.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.customer CSV DATA ('userfile:///a_customer.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.item CSV DATA ('userfile:///a_item.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.orders CSV DATA ('userfile:///a_order.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.order_line CSV DATA ('userfile:///a_order-line.csv') WITH NULLIF='null'
;

IMPORT INTO CS5424.stock CSV DATA ('userfile:///a_stock.csv') WITH NULLIF='null'
;
